...
const NOT_THROUGH = new Set(['module', 'plan', 'block', 'prop', 'field', 'type', 'product']);
...
class Graph {
    ...
    // Every same-kind pair that shares a neighbour (ctx check --deep — Karpathy's lint --deep): the pairs a whole-graph
