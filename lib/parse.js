...
function collectTypes(files, opts = {}) {
    ...
    for (const { file, chunks } of read) {
        ...
        for (const c of chunks) {
            ...
            const t = { id: c.id, slug: c.id.slice(5), extends: null, open: false, purpose: '', home: '', plural: '', statuses: [], ownProps: [], ownShapes: [], file: rel, line: c.line };
...
function parseWith(files, ontology, kinds, opts = {}) {
    ...
    const typeList = [...types.values()].map(t => ({ id: t.id, slug: t.slug, extends: t.extends, chain: t.chain, open: t.open, purpose: t.purpose, home: t.home, plural: t.plural || '', statuses: t.statuses || [], props: t.props, shapes: t.shapes, file: t.file, line: t.line }));
