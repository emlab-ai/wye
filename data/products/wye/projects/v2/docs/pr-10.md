...
What the other session is changing (decision:wf2.text-is-first-block on pr:9):
...
_`- [ ] task:` lines, `part of pr:10`; their check state is what is in progress._
...
- added pr:11 — i told you not to show in the card, additional blocks only first one, the reset is in…
...
87 paragraphs added or changed — [per document](/wye/sessions/7205676ec8/changes)
