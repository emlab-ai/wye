...
- id: page:skill/context-v2
  route: skills/wye-context/SKILL.md (rewritten)
  component: skills/wye-context/SKILL.md
  description: >
...
- id: page:skill/describe-module
  route: ~/.claude/skills/wye-describe-module/SKILL.md (symlink)
  component: skills/wye-describe-module/SKILL.md:1-45
  ...
  actions:
    - action:explore-server:  reference prompt skills/wye-describe-module/references/explore-server.md
    - action:explore-client:  reference prompt skills/wye-describe-module/references/explore-client.md
  ---
  id: page:skill/context
  route: ~/.claude/skills/wye-context/SKILL.md (symlink)
  component: skills/wye-context/SKILL.md:1-61
