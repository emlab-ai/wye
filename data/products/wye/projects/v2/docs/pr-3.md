...
- changed type:pr — moved from wye/v2/ontology.md to schema/base-ontology.md (extends module;
...
- added decision:wf2.plan-type-is-base — type:pr is a base type in schema/base-ontology.md, not a card of the wye product
- added task:wf2.plan-type-move-base — Move the type:pr card from data/products/wye/projects/v2/docs/ontology.md to schema/base-ontology.md (
...
80 paragraphs added or changed — [per document](/wye/sessions/07aa6645ad/changes)
