...
- [ ] task:exec.switch-impact-on Set `impact: auto` (or manual) in waterfall's _product.md when the person wants change records judged — flag:impact defaults off; verdicts and consolidation are the same call (task:memory.impl.switch-on). part of pr:15
