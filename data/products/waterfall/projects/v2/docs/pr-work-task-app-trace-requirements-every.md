---
node: pr:pr-work-task-app-trace-requirements-every
type: pr
...
_`- [ ] task:` lines, `part of pr:pr-work-task-app-trace-requirements-every`; their check state is what is in progress._
...
- changed task:pr-why-t-type-space-typing-answer — why i can't type space when typing answer???
- changed pr:pr-why-t-type-space-typing-answer — why i can't type space when typing answer??? also no answer in details, it must be like…
...
- changed pr:pr-build-one-too — build this one too
