...
- [ ] task:new-453 we need to add. a section/block or page which can show us all cards of specific type with filter, i.e. if i want to show all pages, or all manager or all tasks .. (session: 53f99bfd98, produced: module:scratch-paste-test)
