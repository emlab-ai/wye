...
- id: req:wf2.store.products
  title: A product groups projects
  when: several repos belong to one thing being built
  then: they are registered under one product node and the sidebar and projects.list show them grouped
  status: proposed
