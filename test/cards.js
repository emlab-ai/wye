...
assert.deepStrictEqual(routeToFiles('skills/waterfall-context/SKILL.md', exists), []);
...
const comp = fs.readFileSync(path.join(root, 'data/products/waterfall/projects/v2/docs/components.md'), 'utf8');
...
const stor = fs.readFileSync(path.join(root, 'data/products/waterfall/projects/v2/docs/app-storage.md'), 'utf8');
assert.ok(stor.includes('- id: lib:thing\n  file: packages/web/src/lib/thing.ts'), 'lib goes to the page holding what it imports');
const api = fs.readFileSync(path.join(root, 'data/products/waterfall/projects/v2/docs/api.md'), 'utf8');
assert.ok(api.includes('  source: packages/web/src/app/api/[product]/ping/route.ts'), 'op source tightened');
const pages = fs.readFileSync(path.join(root, 'data/products/waterfall/projects/v2/docs/pages.md'), 'utf8');
