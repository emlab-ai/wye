export interface GraphNode { id: string; kind: string; title: string; status: string; section: string; subsection: string; body: string; defined: boolean; file: string; line: number; owner?: string; partKeys?: string[]; form?: 'prose' | 'yaml' | 'block'; since?: string; until?: string; by?: string; supersededBy?: string; archived?: boolean }
...
export interface TypeDef { id: string; slug: string; extends: string | null; chain: string[]; open: boolean; purpose: string; home: string; plural?: string; props: PropDef[]; shapes?: ShapeDef[]; file: string; line: number }
