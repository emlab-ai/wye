...
export function CodeView({ file }: { file: string }) {
  ...
  return (
    <div className="code-view">
      ...
      <Editor height="100%" language={code.language} value={code.text} theme={dark ? 'vs-dark' : 'vs'} onMount={onMount} options={{ readOnly: true, minimap: { enabled: false }, fontSize: 12, lineNumbers: 'on', scrollBeyondLastLine: false, wordWrap: 'off', renderLineHighlight: 'line', automaticLayout: true, folding: true, contextmenu: false }} />
    </div>
  );
}
